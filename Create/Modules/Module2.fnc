...
# the creation tool will take the name of your module file ('Module2.fnc') and use the first letter as the getopt parameter
# Since this file is called Module2, we would have ./Intersect-Custom.py -m  OR ./Intersect-Custom.py --module2
